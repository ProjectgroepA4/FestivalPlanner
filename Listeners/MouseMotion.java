...
public class MouseMotion extends MouseMotionAdapter
{
	...
	public void mouseDragged(MouseEvent e)
	{
		...
		if (panel.getDragObject() != null)
		{
			...
			case "drag":
				if (panel.getDragObject() != null)
					panel.getDragObject().setPosition(new Point2D.Double((panel.getDragObject().getPosition().getX()) - ((panel.getLastClickPosition().getX() - clickPoint.getX())), (panel.getDragObject().getPosition().getY()) - (panel.getLastClickPosition().getY() - clickPoint.getY())));
				break;
			case "upperLeft":
